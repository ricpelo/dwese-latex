...
\DeclareTCBListing[use counter from=contador]{#1}{ O{\url{\thetcbcounter.#6}} O{} }{%
    ...
    minted language=#3,
    minted options={fontsize=\codigofontsize,linenos,numbersep=3mm,#5},
...
\DeclareTCBInputListing[use counter from=contador]{#1}{ O{} O{} m }{%
    ...
    drop fuzzy shadow,
    oversize,
    adjusted title=Listado~\thetcbcounter: \href{##3}{\ifblank{##1}{##3}{##1}},
    before title={\hypersetup{urlcolor=\urlcolor,filecolor=\urlcolor}},
    overlay={\begin{tcbclipinterior}\fill[red!20!blue!20!white] (frame.south west)
            rectangle ([xshift=8mm]frame.north west);\end{tcbclipinterior}},
    #4,
...
\DeclareTCBListing[use counter from=contador]{phpsimple}{}{%
    listing engine=minted,
    minted language=php,
    minted options={fontsize=\codigofontsize,startinline,firstline=3,firstnumber=1},
    listing file={code/\thetcbcounter.php},
    run system command={./linter.sh php \thetcbcounter.php},
    colback=white,
    colframe=\codigocolframe,
    fonttitle=\large\bfseries,
    listing only,
    enhanced,arc=0mm,outer arc=0mm,
    boxrule=0mm,toprule=1mm,bottomrule=1mm,left=0mm,right=0mm,
    titlerule=0mm,toptitle=0mm,bottomtitle=1mm,top=2mm,
    adjusted title=\href{code/\thetcbcounter.php}{\url{\thetcbcounter.php}},
    before title={\hypersetup{urlcolor=\urlcolor,filecolor=\urlcolor}}
}

%\listado{phpsimple}{php}{php}{colback=white,colframe=red!75!black,listing only,
%    adjusted title=\href{code/\thetcbcounter.php}{\ttfamily\thetcbcounter.php},
%    enlarge left by=0mm,enlarge right by=0mm,
%    enhanced,arc=0mm,outer arc=0mm,
%    boxrule=0mm,toprule=1mm,bottomrule=1mm,left=0mm,right=1mm,
%    titlerule=0mm,toptitle=0mm,bottomtitle=1mm,top=2mm,no shadow,overlay={}}{startinline,firstline=3,firstnumber=1}{php}
...
%\begin{tcblisting}{listing engine=minted,minted style=colorful,
%        minted language=java,
%        colback=white,colframe=red!75!black,listing only,
%        title=Hola,
%        enhanced,arc=0mm,outer arc=0mm,
%        boxrule=0mm,toprule=1mm,bottomrule=1mm,left=0mm,right=1mm,
%        titlerule=0mm,toptitle=0mm,bottomtitle=1mm,top=2mm}
