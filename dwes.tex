...
\newcommand{\listadosimple}[6]{%
\DeclareTCBListing[use counter from=contador]{#1}{ O{} O{} }{%
    listing engine=minted,
    minted language=#3,
    minted options={fontsize=\codigofontsize,#5, ##1},
    listing file={code/\thetcbcounter.#6},
    run system command={./linter.sh #2 \thetcbcounter.#6},
    colback=white,
    colframe=\codigocolframe,
...
\listadosimple{phpsimple}{php}{php}{}{startinline,firstline=3,firstnumber=1}{php}

% Las líneas anteriores crean entornos con estas opciones:
% \begin{entorno}[opciones adicionales para minted][opciones adicionales para \newtcblisting]
% \end{entorno}
