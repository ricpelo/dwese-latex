...
\newcommand{\mitcb}[5]{%
\newtcblisting[auto counter,number within=section]{#1}[1][\url{code/\thetcbcounter.#2}]{
...
\newcommand{\miitcb}[5]{%
\newtcbinputlisting[auto counter,number within=section]{#1}[2][]{
    listing engine=minted,
    minted language=#3,
    minted options={fontsize=\small,linenos,numbersep=3mm,#5},
    listing file=##2,
    run system command={./linter.sh #2 ##2},
    colback=blue!5!white,
    colframe=red!75!black,
    listing only,
    #4,
