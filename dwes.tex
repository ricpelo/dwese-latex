...
\renewcommand{\cftchapteraftersnum}{.\hspace*{\numchapterlen}}
...
\renewcommand{\cftpartaftersnum}{.}
\renewcommand*\cftpartindent{3em}
\renewcommand*\cftpartnumwidth{3em}
\renewcommand*\cftchapterindent{6em}
...
\chapterprecishere{Donde se habla de ésto y de aquello.}
